...
$userName = strlen($userName) > 8 ? substr($userName, 0, 8).'...' : $userName;
     ...
     <div class="user-profile dropdown">
         <div data-bs-toggle="dropdown" aria-expanded="false">
                <img src="/assets/img/user.png"  width="32" height="32" class="rounded-circle" alt="Profile">
         ...
         <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="/citoyen/demandes"><i class="bi bi-gear me-2"></i>Mes demandes</a></li>
                <li>
...
HTML : <<<HTML
     <a class="btn btn-outline-light" href="login">Se connecter</a>
HTML;
    }
}
