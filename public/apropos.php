...
<div class="container">
    ...
    <section class="hero-section">
        <div class="container text-center">
            <h1 class="display-3 fw-bold mb-4">À propos de Cocody</h1>
            <p class="lead">Découvrez l'histoire, les valeurs et les ambitions de notre commune</p>
        </div>
    </section>
    ...
    <section class="container mb-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="https://example.com/cocody-panorama.jpg" alt="Panorama de Cocody" class="img-fluid rounded shadow">
            </div>
        </div>
    </section>
    ...
    <section class="py-5 bg-primary text-white">
        <div class="container text-center">
            <h2 class="mb-4">Engagez-vous avec nous</h2>
            <p class="lead mb-4">Vous souhaitez contribuer au développement de Cocody ? Découvrez nos différents programmes citoyens.</p>
            <a href="#" class="btn btn-light btn-lg px-4 me-2">Devenir bénévole</a>
            <a href="#" class="btn btn-outline-light btn-lg px-4">Proposer un projet</a>
        </div>
    </section>
   </div>
