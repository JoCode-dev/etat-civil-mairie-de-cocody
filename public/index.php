...
<?php require_once __DIR__ . '/citoyen/includes/header.php'; ?>
 ...
 <section class="hero">
        ...
        <div class="d-flex justify-content-center mt-4 ">
            <a href="acte_demande" class="btn btn-primary me-2 rounded-pill" style="background-color: var(--orange)">Faire une demande d'acte</a>
            <a href="contact.php" class="btn btn-secondary rounded-pill" style="opacity: 0.8;">Nous contacter</a>    </div>
    </section>
    ...
    <div class="container">
        <section class="services">
            <div class="service-card">
                <img src="/assets/img/doc.png" alt="Extrait de naissance">
                <div class="service-content">
                    <h3>Extrait de Naissance</h3>
                    <p>Demandez un extrait d'acte de naissance en ligne rapidement et facilement.</p>
                    <a href="demande-naissance.php" class="btn">Faire une demande</a>
                </div>
            </div>
            
            <div class="service-card">
                <img src="/assets/img/doc.png" alt="Extrait de mariage">
                <div class="service-content">
                    <h3>Extrait de Mariage</h3>
                    <p>Obtenez un extrait d'acte de mariage pour vos démarches administratives.</p>
                    <a href="demande-mariage.php" class="btn">Faire une demande</a>
                </div>
            </div>
            
            <div class="service-card">
                <img src="/assets/img/doc.png" alt="Extrait de décès">
                <div class="service-content">
                    <h3>Extrait de Décès</h3>
                    <p>Faites une demande d'extrait d'acte de décès en toute simplicité.</p>
                    <a href="demande-deces.php" class="btn">Faire une demande</a>
                </div>
            </div>
        </section>    
        ...
        <section class="actualites">
            ...
            <div class="actus-grid">
                <div class="actu-card">
                    <img src="images/actu-fete.jpg" alt="Fête de la musique">
                    <div class="actu-content">
                        ...
                        <a href="actu-fete-musique.php" class="btn">Lire la suite</a>
                    </div>
                </div>
                
                <div class="actu-card">
                    <img src="images/actu-travaux.jpg" alt="Travaux routiers">
                    <div class="actu-content">
                        ...
                        <a href="actu-travaux.php" class="btn">Lire la suite</a>
                    </div>
                </div>
                
                <div class="actu-card">
                    <img src="images/actu-conseil.jpg" alt="Conseil municipal">
                    <div class="actu-content">
                        ...
                        <a href="actu-conseil.php" class="btn">Lire la suite</a>
                    </div>
                </div>
            </div>
            <div style="text-align: center; margin-top: 30px;">
                <a href="actualites.php" class="btn">Voir toutes les actualités</a>
            </div>
        </section>
    </div>
