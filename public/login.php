...
require_once '../app/Helpers/ActionHelper.php';
...
<div class="container">
    ...
    <div class="login-container mt-4 d-flex flex-column flex-lg-row align-items-center align-items-lg-start">
        ...
        <div class="login-header text-center me-lg-5">
             ...
             <img src="/assets/img/favicon.png" alt="Logo" class="img-fluid mt-3" style="max-width: 200px; display: block; margin: 0 auto;">
        ...
        <div class="login-form w-100 mt-4 mt-lg-0">
            ...
            <form action="" method="POST">
                ...
                <div class="d-flex justify-content-center mt-5">
                    ...
                    <a href="/registre" class="ms-2">Enregistrez-vous</a>
                </div>
            </form>
        </div>
    </div>
